      ...
      <div className="flex h-full w-full items-center justify-center p-8">
        <div className="max-w-lg space-y-4 text-center">
          ...
          <p className="text-xs text-muted-foreground">
            See <code className="rounded bg-muted px-1 py-0.5 text-xs">scripts/build-tiles.md</code> for how to generate the
            extract with <code className="rounded bg-muted px-1 py-0.5 text-xs">pmtiles extract</code>.
          </p>
        </div>
      </div>
    );
