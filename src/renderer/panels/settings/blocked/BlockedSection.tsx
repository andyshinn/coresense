import { Plus, ShieldOff, ToggleLeft, ToggleRight, Trash2 } from 'lucide-react';
...
export function BlockedSection({ client }: Props) {
  ...
  return (
    <SettingsSection
      ...
      description="Hide messages matching these rules everywhere."
      dirty={false}
    >
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <Input
            ...
            className="max-w-sm"
          />
          <Button onClick={() => setShowAdd(true)} size="sm" className="ml-auto">
