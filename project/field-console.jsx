...
function FCAddChannelPopover({ theme, onClose }) {
  ...
  return (
    ...
    >
      ...
      />
      <Item
        glyph={<FCChannelGlyph type="private" theme={{ ...theme, textDim: theme.text }} />}
        title="Join private channel"
        subtitle="Paste a shared key"
      />
      <Item
        glyph={<FCChannelGlyph type="public" theme={{ ...theme, textDim: theme.text }} />}
        title="Join public channel"
        subtitle="Anyone in range"
      />
      <Item
        glyph={<FCChannelGlyph type="hashtag" theme={{ ...theme, textDim: theme.text }} />}
      ...
      <Item
        glyph={
          ...
          >
            ...
            <path d="M9 9h2v2 M13 9v2 M9 13h2 M13 13h1" />
          </svg>
        }
        title="Scan QR"
...
function FCConnectionMenu({ theme, onClose }) {
  const Row = ({ glyph, label, sub, status, active }) => (
    <div
      ...
      onMouseEnter={(e) => {
        if (!active) e.currentTarget.style.background = theme.bg3;
      }}
      onMouseLeave={(e) => {
      ...
      {status && (
        <span
          style={{
            fontFamily: MONO,
            fontSize: 9,
            color: status === 'connected' ? theme.online : theme.textDim,
            padding: '1px 5px',
            background: theme.bg3,
            border: `1px solid ${theme.border}`,
            borderRadius: 2,
      ...
      <Row
        glyph={
          <svg
            ...
            strokeWidth="1.5"
          >
            <path d="M5 3v4 M11 3v4 M3 7h10v3a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3z M8 13v3" />
          </svg>
        }
        label="USB Serial"
        sub="/dev/cu.usbmodem01 · 115200"
        status="connected"
        active
      />
      <Row
        glyph={
          <svg
            ...
            strokeWidth="1.5"
          >
            <path d="M6 3l5 5-5 5V3z M5 6l4 4 M5 10l4-4" />
          </svg>
        }
        label="Bluetooth LE"
        sub="egrme.sh Hand · paired"
        status="ready"
      />
      <Row
        glyph={
          <svg
            ...
            strokeWidth="1.5"
          >
            <path d="M2 6c4-3 8-3 12 0 M4 9c2.5-2 5.5-2 8 0 M6 12c1.5-1 2.5-1 4 0" />
            <circle cx="8" cy="14" r="0.8" fill="currentColor" stroke="none" />
          </svg>
        }
        label="TCP"
        sub="192.168.1.42:5000"
        status=""
      />
      <div style={{ height: 1, background: theme.border, margin: '4px 0' }} />
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <div
            style={{
              ...
              boxShadow: `0 0 8px ${theme.online}`,
            }}
          />
          <div
            style={{
          ...
          <button
            ...
            style={{
              ...
              padding: 0,
              border: 'none',
              background: openPopover === 'settings' ? theme.bg3 : 'transparent',
              color: theme.textMuted,
              cursor: 'pointer',
              borderRadius: 3,
              display: 'flex',
        ...
        <div style={{ fontFamily: MONO, fontSize: 10, color: theme.textDim, marginTop: 4 }}>
          {data.owner.pkShort}
        </div>
        <div
          style={{
        ...
        >
          <div style={{ color: theme.textDim }}>
            FREQ <span style={{ color: theme.text }}>910.5</span>
          </div>
          <div style={{ color: theme.textDim }}>
            SF <span style={{ color: theme.text }}>{data.owner.sf.replace('SF', '')}</span>
          </div>
          <div style={{ color: theme.textDim }}>
            BW <span style={{ color: theme.text }}>62.5</span>
          </div>
          <div style={{ color: theme.textDim }}>
            TX <span style={{ color: theme.text }}>{data.owner.txPower}dB</span>
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div
            style={{ width: `${data.owner.battery}%`, height: '100%', background: theme.accent }}
          />
        </div>
        <div
          style={{
        ...
        >
          <span>BATT {data.owner.battery}%</span>
          <span>{data.owner.voltage}V</span>
        </div>
        ...
        {channels.map((ch) => {
          ...
          return (
            ...
            >
              ...
              {ch.unread > 0 && (
                <span style={{ fontSize: 9, fontFamily: MONO, color: theme.accent }}>
                  {ch.unread}
                </span>
              )}
            </div>
        ...
        {contacts.map((c) => {
          ...
          return (
            ...
            >
              ...
              <span style={{ fontFamily: MONO, fontSize: 9, color: theme.textDim }}>
                {FCFmtTime(c.lastSeen)}
              </span>
            </div>
          );
        })}
      ...
      <div style={{ position: 'relative', borderTop: `1px solid ${theme.border}` }}>
        <button
          ...
          style={{
            ...
            gap: 8,
            padding: '8px 12px',
            background: openPopover === 'conn' ? theme.bg3 : 'transparent',
            color: theme.textMuted,
            border: 'none',
            cursor: 'pointer',
            fontFamily: MONO,
        ...
        >
          <span
            style={{
              ...
              borderRadius: 3,
              background: theme.online,
              boxShadow: `0 0 6px ${theme.online}`,
            }}
          />
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
          <span
            style={{ fontFamily: MONO, fontSize: 10, color: theme.textDim, letterSpacing: 0.5 }}
          >
            MESSAGE INFO
          </span>
          <div style={{ flex: 1 }} />
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontFamily: MONO, fontSize: 13, color: theme.text }}>
              {msg.repeats != null ? msg.repeats : Math.max(1, hops.length)}
            </div>
          </div>
          <div>
            ...
            <div
              style={{
                fontFamily: MONO,
                fontSize: 11,
                color: msg.state === 'acked' ? theme.online : theme.warn,
              }}
            >
              {msg.state || 'received'}
            </div>
        ...
        >
          ...
          <span style={{ color: theme.text }}>
            0x{(((msg.id || 'm').charCodeAt(1) * 1721) % 0xffff).toString(16).padStart(4, '0')}
          </span>
...
function FCMessage({ m, theme, onSelect, selected }) {
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (!selected) e.currentTarget.style.background = theme.bg2;
      }}
      onMouseLeave={(e) => {
        if (!selected) e.currentTarget.style.background = 'transparent';
      }}
    >
      <div style={{ fontFamily: MONO, fontSize: 10, color: theme.textDim, paddingTop: 2 }}>
        {m.time}
      </div>
      <div style={{ minWidth: 0 }}>
        ...
        >
          ...
          {m.state === 'sending' && (
            <span style={{ fontFamily: MONO, fontSize: 9, color: theme.warn }}>tx…</span>
          )}
          {m.state === 'acked' && (
            <span style={{ fontFamily: MONO, fontSize: 9, color: theme.online }}>ack</span>
          )}
          {m.state === 'relayed' && (
            <span style={{ fontFamily: MONO, fontSize: 9, color: theme.warn }}>relay</span>
          )}
        </div>
...
function FCChannelHeader({ theme, channelKey }) {
  ...
  return (
    ...
    >
      {glyph}
      <span style={{ fontFamily: 'inherit', fontSize: 13, fontWeight: 600, color: theme.text }}>
        {label}
      </span>
  ...
  const lines = [
    {
      ...
      kind: 'ADV',
      src: '<87ace08a>',
      meta: 'rssi=-68 snr=8.2',
      body: 'advert · SOCO Meshcore RAK',
    },
    {
      t: '17:42:04.018',
      dir: 'rx',
      ...
      src: 'FLO1',
      meta: '9h · 1b · ack',
      body: 'Cool, my new Cedar Park repeater worked',
    },
    {
      t: '17:42:09.401',
      dir: 'sys',
      ...
      src: 'router',
      meta: '',
      body: 'route updated: Cedar Park via SOCO Meshcore RAK',
    },
    {
      t: '17:42:12.220',
      dir: 'tx',
    ...
    },
    {
      ...
      kind: 'ADV',
      src: '<698fc698>',
      meta: 'rssi=-82 snr=5.4',
      body: 'advert · SOCO RAK 1W',
    },
    { t: '17:42:23.000', dir: 'cmd', kind: 'CMD', src: 'self', meta: '', body: 'get telemetry' },
    {
      ...
      src: 'self',
      meta: '',
      body: '{ battery: 87%, airtime: 2.3%, uptime: 12d 4h }',
    },
    {
      t: '17:42:30.812',
      dir: 'rx',
      ...
      src: 'Ave Maritza-M',
      meta: '2h · 1b',
      body: '#meetup · who is bringing antennas',
    },
    {
      t: '17:42:34.114',
      dir: 'sys',
      ...
      src: 'router',
      meta: '',
      body: 'neighbor SOCO RAK 1W airtime warning: 4.7%',
    },
    {
      t: '17:42:40.557',
      dir: 'tx',
      ...
      src: 'self',
      meta: '#meshcore',
      body: 'rxing you 5×9 down here',
    },
    {
      t: '17:42:41.220',
      dir: 'rx',
      kind: 'ACK',
      src: 'SOCO Meshcore RAK',
      meta: 'msg=4f2a',
      body: 'heard 1 repeat',
    },
    {
      ...
      src: 'Picassoman-M',
      meta: '3h · 2b',
      body: '@Ave Maritza-M nothing in dripping',
    },
    {
      t: '17:42:50.118',
      dir: 'rx',
      ...
      src: 'WX-Roof',
      meta: '1h',
      body: '{ tempC: 18.3, rh: 62, wind: 4.1 }',
    },
    {
      t: '17:42:55.404',
      dir: 'rx',
      kind: 'ADV',
      src: '<4471a2c9>',
      meta: 'rssi=-94 snr=2.1',
      body: 'advert · Bender DT',
    },
  ];
  const dirColor = (d) =>
    d === 'rx'
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: '8px 0', fontFamily: MONO, fontSize: 11.5 }}>
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: '94px 28px 38px 130px 1fr 130px',
          gap: 8,
          padding: '4px 20px',
          fontSize: 9,
          color: theme.textDim,
      ...
      {!isPacket && (
        ...
        >
          ...
          >
            ...
            <span style={{ flex: 1, color: theme.textDim }}>
              tx to {channelKey && channelKey.startsWith('ch:') ? channelKey.slice(3) : 'channel'}_
            </span>
