...
import {
  decodeTuningParams,
  encodeGetTuningParams,
  encodeSetTuningParams,
} from '../../../../../src/main/protocol/features/tuning';
...
describe('tuning: encodeSetTuningParams', () => {
  it('lays out [0x15][rx×1000 u32 LE][airtime×1000 u32 LE]', () => {
    ...
    expect(hex(encodeSetTuningParams({ rxDelayBase: 10, airtimeFactor: 1 }))).toBe(
      '1510270000e8030000',
    );
  });
  ...
  it('rounds fractional params to the nearest milli-unit', () => {
    ...
    expect(hex(encodeSetTuningParams({ rxDelayBase: 12.5, airtimeFactor: 2.345 }))).toBe(
      '15d430000029090000',
    );
  });
});
